        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/outils" className="text-gray-400 hover:text-cyan-300 transition-colors">
                  Nos outils
                </Link>
              </li>
              <li>
                <Link href="/services" className="text-gray-400 hover:text-cyan-300 transition-colors">
                  Services
                </Link>
              </li>
              <li>
