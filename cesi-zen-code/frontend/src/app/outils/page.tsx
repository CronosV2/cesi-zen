  ...
  return (
    <div className="min-h-screen pt-24 px-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-12 text-cyan-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, index) => (
            ...
            >
              ...
              <h2 className="text-xl font-semibold mb-2 text-cyan-300">{tool.name}</h2>
              <p className="text-gray-600">{tool.description}</p>
              <button className="mt-4 w-full bg-cyan-300 text-white py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200">
                Accéder
              </button>
            </div>
          ))}
